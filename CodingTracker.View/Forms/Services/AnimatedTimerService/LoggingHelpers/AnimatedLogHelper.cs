...
namespace CodingTracker.View.Forms.Services.AnimatedTimerService.LoggingHelpers
{
    ...
    {
        void LogColumn(AnimatedTimerColumn column, TimeSpan elapsed, ColumnAnimationType columnAnimationType, float? initialYLocation, float? easedProgress, float? yTranslation);
    ...
    public class AnimatedLogHelper : IAnimatedLogHelper
    {
        ...
        public void LogColumn(AnimatedTimerColumn column, TimeSpan elapsed, ColumnAnimationType columnAnimationType ,float? initialYLocation, float? easedProgress, float? yTranslation)
        {
            string logMessage = $"\n \n"
